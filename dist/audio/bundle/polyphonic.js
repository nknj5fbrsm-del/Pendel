...
export class PolyphonicBundle {
    constructor(ctx) {
        this.id = "polyphonic";
        this.label = AUDIO_BUNDLE_LABELS.polyphonic;
        this.description = AUDIO_BUNDLE_DESCRIPTIONS.polyphonic;
        this.nodes = [];
        this.stepBob1 = 0;
        this.stepBob2 = 0;
        this.stepBall = 0;
        ...
        const blueNodes = [];
        const pinkNodes = [];
        this.blue = new ScaleMelodyPlayer(BRIGHT_MELODY_SCALE, [
            makeMonoVoice(blueOut, {
        ...
        this.pink = new ScaleMelodyPlayer(WARM_MELODY_SCALE, [
            makeMonoVoice(pinkOut, {
...
export function createPolyphonicBundle(ctx) {
