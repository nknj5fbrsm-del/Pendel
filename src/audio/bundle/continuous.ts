...
export class ContinuousBundle implements AudioBundle {
  readonly id = "continuous" as const;
  readonly label = AUDIO_BUNDLE_LABELS.continuous;
  readonly description = AUDIO_BUNDLE_DESCRIPTIONS.continuous;

  private readonly blueDrone: any;
  private readonly pinkDrone: any;
  ...
  onBallCollisions(_now: number, _events: BallCollisionEvents, _snap: SimulationSnapshot): void {
...
export function createContinuousBundle(ctx: BundleContext): AudioBundle {
